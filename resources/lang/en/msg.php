...
return[
        ...
        "year"=>"Year",
        "month"=>"Month",
        "État Créé"=>"State created",
        "État Invalide"=>"invalid States",
        "État Valide"=>"Validate Status",
        "État À supprimer"=>"Status to be deleted",
        "gc"=>"Item Pie Chart",
        "ga"=>"Item Area Chart (per day)",
        "gb"=>"Item bar graph (per month)",
        "mis"=>"Updated at :",
        "Filtrer"=>"Filter",
