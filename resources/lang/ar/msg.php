...
return[
        ...
        "Users"=>"المستخدمين",
        "Groupe"=>"المجموعات",
        "État Créé"=>"حالة إنشاء",
        "État Invalide"=>"حالةإبطال",
        "État Valide"=>"الحالة المصادق عليها",
        "État À supprimer"=>"الحالة المراد حذفها",
        "Dashboard"=>"لوحة القيادة",
        "Voir les détails"=>"عرض التفاصيل",
        "gc"=>"رسم بياني دائري لحالة العناصر",
        "ga"=>"(يومي)رسم بياني للعناصر",
        "gb"=>"(شهري)رسم بياني بالأعمدة للعناصر",
        "mis"=>"تم التحديث في :",
        "Filtrer"=>"تحديد",
        "year"=>"السنة",
        "month"=>"الشهر",
