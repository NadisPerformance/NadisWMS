                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <x-jet-input placeholder="Libellé du transporteur" id="Libelle" class="block mt-1 w-full" type="text"
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-check form-switch">
                                    <input value=1 class="form-check-input" name="mouvementReception" type="checkbox" id="mouvementReception">
                                    <label class="form-check-label" for="mouvementReception">Les mouvements de réception</label>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-check form-switch">
                                    <input value=1 class="form-check-input" name="mouvementInterne" type="checkbox" id="mouvementInterne">
                                    <label class="form-check-label" for="mouvementInterne">Les mouvements internes</label>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-check form-switch">
                                    <input value=1 class="form-check-input" name="mouvementExpedition" type="checkbox" id="mouvementExpedition">
